    ...
    <div className="fixed bottom-0 left-0 right-0 bg-gray-900/95 backdrop-blur border-t border-gray-700 p-4 shadow-2xl z-50">
      <div className="max-w-3xl mx-auto flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button onClick={() => onAdjust(-60)} className="px-3 py-2 bg-gray-800 hover:bg-gray-700 text-gray-300 text-xs sm:text-sm rounded border border-gray-600 transition-colors font-mono">-1m</button>
          <button onClick={() => onAdjust(-10)} className="px-3 py-2 bg-gray-800 hover:bg-gray-700 text-gray-300 text-xs sm:text-sm rounded border border-gray-600 transition-colors font-mono">-10s</button>
        </div>
